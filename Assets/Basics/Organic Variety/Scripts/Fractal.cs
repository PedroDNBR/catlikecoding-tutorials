    ...
    public class Fractal : MonoBehaviour
    {
        ...
        struct UpdateFractalLevelJob : IJobFor
        {
            ...
            public void Execute(int i)
            {
                ...
                float sagMagnetude = length(sagAxis);
                quaternion baseRotation;
                if(sagMagnetude > 0f)
                {
                    sagAxis /= sagMagnetude;
                    quaternion sagRotation =
                    quaternion.AxisAngle(sagAxis, part.maxSagAngle * sagMagnetude);
        ...
        void Update()
        {
            ...
            for (int i = 0; i < matricesBuffers.Length; i++)
            {
                ...
                {
                    float gradientInterpolator = i / (matrices.Length - 1f);
